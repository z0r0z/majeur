...
contract Summoner {
    ...
    function summon(
        ...
        dao.init(
            orgName, orgSymbol, orgURI, quorumBps, ragequittable, initHolders, initShares, initCalls
        );
        daos.push(dao);
